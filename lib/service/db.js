...
var executeAsync = function () {
    var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(sql, options) {
                                    ...
                                    while (1) {
                                        switch (_context2.prev = _context2.next) {
                                            ...
                                            case 2:
                                                ...
                                                return _context2.abrupt('return', reject('无法获取到数据库连接'));
    ...
    return function executeAsync(_x2, _x3) {
